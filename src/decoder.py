...
class LayoutDecoder:
    ...
    def render(self,
        ...
        for element in layout[:no_elements]:
            ...
            min_x = center_x - round(width/2.)
            min_y = center_y - round(height/2.)
            ...
            height = round(np.clip(height/(self.resolution_w-1), 0, 1) * canvas_h)
    ...
    def generate_from_layout(self, input, offset, possible_logit,
        ...
        render = self.render(generated, offset, canvas_w=canvas_w, canvas_h=canvas_h)
        return generated, render

    async def generate_from_layout_to_json(self, input, offset, possible_logit,
                                           input_mask_token=-1, output_mask_token=3,
                                           pad_token=0, canvas_w=255, canvas_h=300):
